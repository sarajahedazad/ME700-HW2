...
el0 = frame.add_element( p0, p1, E, nu, A, Iy, Iz, I_rho, J, v_temp_0 )
el1 = frame.add_element( p1, p2, E, nu, A, Iy, Iz, I_rho, J, v_temp_1 )
element_lst = [el0, el1]
...
# force bounds
bcs.add_force_bound_xyz( [15, 0, 10], -0.05, 0.075, 0.1 )
